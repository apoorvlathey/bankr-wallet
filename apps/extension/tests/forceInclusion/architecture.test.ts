...
const DOMAIN_MODULES = [
    ...
    "forceInclusion/depositParams.ts",
    ...
    "forceInclusion/bundleRecovery.ts",
    ...
    "forceInclusion/privacyDropMirrors.ts",
    "forceInclusion/receiptAuthorityMirrors.ts",
    "forceInclusion/replacementReceiptMirror.ts",
