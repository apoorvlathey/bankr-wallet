...
| `restoration.ts` | Authoritative unified/released-envelope re-read, branded unlock proof, type/factor/lease/timeout rechecks, migration, and failure teardown | Bounded decrypted key capability or released password during unlock |
