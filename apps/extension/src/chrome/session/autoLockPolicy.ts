 ...
 * side effects. `timeoutTransitions.ts` revokes a persisted capability after
 * this module reports any timeout-policy change.
 */

import { DEFAULT_AUTO_LOCK_TIMEOUT_MS } from "@/constants/securityPolicy";
import { VALID_AUTO_LOCK_TIMEOUTS } from "./timeoutValues";
