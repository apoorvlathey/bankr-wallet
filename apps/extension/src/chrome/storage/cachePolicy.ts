...
/** Pure plan for every cache except the portfolio domain-owned cache. */
export function buildNonCriticalCachePrunePlan(
  ...
  return { keysToRemove, updates, compactedKeys };
}
