...
export function SafeHomeQuickActions({ accountId, chainId, hasConnectedApps, onSend, onSwap, onShield, onMore }: { accountId: string; chainId: number; hasConnectedApps?: boolean; onSend: () => void; onSwap: () => void; onShield: () => void; onMore: () => void }) {
  return <SafeQuickActions safeAccountId={accountId} chainId={chainId} hasConnectedApps={hasConnectedApps} onSend={onSend} onSwap={onSwap} onShield={onShield} onMore={onMore} />;
}
