...
/**
 * Keeps token contract metadata available without adding another persistent
 * icon to dense clear-signing amount rows. The token identity itself is the
 * hover/focus target; native assets never reach this component because they do
 * not have an ERC-20 contract address to disclose.
 */
