...
WalletChan downloads the domain configuration maintained at
https://github.com/MetaMask/eth-phishing-detect at runtime.

Copyright (c) MetaMask and contributors.

The configuration repository is made available under the Don't Be a Dick
Public License, version 1.2 (DBAD). Its license text follows.

WalletChan uses the configuration for phishing warnings, preserves this
attribution, does not present the data as its own, and does not expose a bulk
...
3. Code is provided with no warranty. Using somebody else's code and bitching
   ...
   non-dick would submit the fix back or submit a
...
4. If you use code, calling it your own would make you a ROYAL dick.
   [How to cite a repo](https://academia.stackexchange.com/questions/14010/how-do-you-cite-a-github-repository).
